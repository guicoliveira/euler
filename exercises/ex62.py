...
def is_permutation(value1: int, value2: int) -> bool:
	value1_str = [letter for letter in str(value1)]
	value2_str = [letter for letter in str(value2)]
	if len(value1_str) != len(value2_str):
		return False
	for letter in str(value1):
		try:
